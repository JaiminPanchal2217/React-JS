...
const carchanges = (e)=>{
  ...
  {
  const Apidcr =  CarsApi.filter((item)=> item.carcompany === e.target.value)
    setToShow(Apidcr)
    setcurrentpage(1)
    ...
    <div>
      ...
      <div className='Selected_options'>
        ...
        <div className='selected_results'>
            ...
            <div>
            <select name="" id="" onChange={(e)=>(setshowcars(e.target.value) , setcurrentpage(1)) }>
...
{/* short by */}
        ...
        <div className='selected_icons'>
          <FaList className='selected-list'/>
            <Link to={'/listing/listinggrid'} ><FaList className='selected-list selected-list-grid'/></Link>
        </div>
...
<div className='ListingList_details'>
     ...
     <div className='Listinglist_name_review'>
       ...
       <div>
           <p className='car_review'><FaStar/><FaStar/><FaStar/><FaStar/><FaStar/>(5.0)</p>
